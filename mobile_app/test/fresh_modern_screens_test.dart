...
void main() {
  ...
  testWidgets('StatusMetricGrid renders 4 metric cards correctly', (WidgetTester tester) async {
    ...
    expect(find.text('Expiring Today'), findsWidgets);
    ...
    expect(find.text('Within 30 Days'), findsOneWidget);
  ...
  testWidgets('MainNavigationScaffold renders all 4 tabs including Calendar', (WidgetTester tester) async {
...
class MockTestSettingsController extends StateNotifier<AsyncValue<AppSettings>>
  ...
  @override
  Future<void> updateDefaultReminderDays(int days) async {}
