...
class ExpiryCountdownBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final statusText = expiryDate != null
        ? ExpiryCalculator.getExpiryStatusText(expiryDate!)
        : 'No Expiry Date';
    ...
    switch (status) {
      case FoodStatus.safe || FoodStatus.fresh:
      ...
      case FoodStatus.expired:
        ...
        break;
      case FoodStatus.noExpiry:
        bg = isDark ? ColorPalette.freshEmerald.withValues(alpha: 0.15) : ColorPalette.freshEmeraldLight;
        fg = ColorPalette.freshEmeraldDark;
        break;
