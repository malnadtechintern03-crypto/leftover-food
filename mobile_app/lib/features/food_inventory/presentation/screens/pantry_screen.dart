  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.alarm_rounded, color: ColorPalette.warningAmber),
            tooltip: 'Expiration Alerts',
            onPressed: () => context.push(RoutePaths.expirationAlerts),
          ),
          IconButton(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        // Status chips
                        ...[
                          (label: 'All Products', status: null),
                          (label: 'Safe', status: FoodStatus.fresh),
                          (label: 'Expiring Soon', status: FoodStatus.expiringSoon),
                          (label: 'Expired', status: FoodStatus.expired),
                          (label: 'Without Expiry Date', status: FoodStatus.noExpiry),
