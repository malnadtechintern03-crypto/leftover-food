                          ...
                          children: [
                            ...
                            if (item.expiryDate != null) ...[
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: ColorPalette.freshEmerald.withValues(alpha: 0.1),
                                  borderRadius: BorderRadius.circular(10),
                                  border: Border.all(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        'Non-expiring product (No expiration date)',
                                        style: theme.textTheme.bodySmall?.copyWith(
                                          fontWeight: FontWeight.w600,
                                          color: ColorPalette.freshEmerald,
                                        ),
                        ...
                        child: Column(
                          children: [
                            _buildInfoRow(
                              ...
                              value: item.subcategory != null && item.subcategory!.trim().isNotEmpty
                                  ? '${item.category.label} • ${item.subcategory!.trim()}'
                                  : item.category.label,
                            ...
                            if (item.price != null && item.price! > 0) ...[
                              ...
                              _buildInfoRow(
                                ...
                                iconColor: ColorPalette.freshEmeraldDark,
                              ),
                            ],
                            const Divider(height: 24),
                            _buildInfoRow(
                            ...
                            if (item.manufacturingDate != null) ...[
                              ...
                              _buildInfoRow(
                                ...
                                value: DateFormatter.formatDate(item.manufacturingDate),
                            ...
                            _buildInfoRow(
                              ...
                              label: 'Status & Shelf-life',
                              value: item.expiryDate != null
                                  ? '${status.label} • ${ExpiryCalculator.formatRemainingTime(item.expiryDate)}'
                            ...
                            _buildInfoRow(
                              ...
                              value: item.reminderEnabled
                                  ? (item.reminderDaysBefore.isNotEmpty
                                          ? '${item.reminderDaysBefore.map((d) => '${d}d').join(', ')} before expiry'
                                          : 'Custom reminder set') +
                                      (item.reminderDate != null
                                          ? ' • ${DateFormatter.formatDate(item.reminderDate)}'
                                          : '')
                                  : 'Reminders Disabled',
                              iconColor: item.reminderEnabled
                      ...
                      if (!item.isConsumed) ...[
                        AppButton(
                          ...
                          onPressed: () async {
                            ...
                            final initialDate = item.expiryDate ??
                            ...
                            if (picked != null) {
                              ...
                              if (context.mounted) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Expiration date updated to ${DateFormatter.formatDate(picked)}!',
                                    ),
                                    backgroundColor:
                        ...
                        OutlinedButton.icon(
                          ...
                          icon: const Icon(Icons.delete_sweep_rounded,
                              color: ColorPalette.sunsetCoral, size: 18),
                          label: const Text(
