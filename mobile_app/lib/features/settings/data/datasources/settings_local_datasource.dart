...
class SettingsLocalDataSourceImpl implements SettingsLocalDataSource {
  ...
  Future<AppSettingsModel> getSettings() async {
    try {
      ...
      final defaultReminderDays = prefs.getInt(AppConstants.keyDefaultReminderDays) ??
          AppConstants.defaultReminderDays;
      final soundEnabled = prefs.getBool(AppConstants.keySoundEnabled) ?? true;
      final vibrationEnabled = prefs.getBool(AppConstants.keyVibrationEnabled) ?? true;
      final dailySummaryEnabled = prefs.getBool(AppConstants.keyDailySummaryEnabled) ?? true;
  ...
  Future<void> saveSettings(AppSettingsModel settings) async {
    try {
      ...
      if (prefs != null) {
        ...
        await prefs.setInt(
            AppConstants.keyDefaultReminderDays, settings.defaultReminderDays);
        await prefs.setBool(
            AppConstants.keySoundEnabled, settings.soundEnabled);
        await prefs.setBool(
            AppConstants.keyVibrationEnabled, settings.vibrationEnabled);
        await prefs.setBool(
            AppConstants.keyDailySummaryEnabled, settings.dailySummaryEnabled);
      }
    } catch (e) {
