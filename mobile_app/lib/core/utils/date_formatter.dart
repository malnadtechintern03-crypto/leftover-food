...
class DateFormatter {
  ...
  static String formatDate(DateTime? date, {String fallback = 'No Expiration Date'}) {
    if (date == null) return fallback;
    return _shortDate.format(date);
  }

  static String formatDayMonth(DateTime? date, {String fallback = 'N/A'}) {
    if (date == null) return fallback;
    return _dayMonth.format(date);
  }

  static String formatMonthYear(DateTime? date, {String fallback = 'N/A'}) {
    if (date == null) return fallback;
    return _monthYear.format(date);
  }

  static String formatTime(DateTime? time, {String fallback = 'N/A'}) {
  ...
  static String formatRelativeDate(DateTime? date, {DateTime? relativeTo, String fallback = 'No Expiration Date'}) {
    if (date == null) return fallback;
