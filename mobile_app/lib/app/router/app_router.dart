...
final appRouterProvider = Provider<GoRouter>((ref) {
  // Wire notification tap to navigate to food details
  NotificationService.onProductNotificationTapped = (productId) {
    rootNavigatorKey.currentContext?.push(RoutePaths.foodDetailPath(productId));
  };
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: RoutePaths.expirationAlerts,
        name: RouteNames.expirationAlerts,
